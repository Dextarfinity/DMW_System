...
1. FOR THE EDIT PPMP ENTRY MODAL, THE EST. BUDGET MUST ALSO BE DYNAMIC AND CAN BE EDITED IN THE EDIT PPMP ENTRY MODAL. WHEN THE USER CHANGES THE QUANTITY OR UNIT PRICE IN THE EDIT PPMP ENTRY MODAL THEN THE EST. BUDGET MUST ALSO CHANGE DYNAMICALLY IN REAL TIME AND ALSO WHEN THE USER SAVES THE CHANGES THEN THE NEW EST. BUDGET MUST BE SAVED IN THE DATABASE AND ALSO DISPLAYED IN THE PPMP PAGE IN REAL TIME WITHOUT REFRESHING THE APPLICATION. LIKE THE USER CAN STILL EDIT THE EST.BUDGET EVEN THE CALCULATED UNIT PRICE AND QUANTITY IS DISPLAYED IN THE EDIT PPMP ENTRY MODAL. THE USER CAN ALSO OVERRIDE THE EST. BUDGET IF THEY WANT TO CHANGE IT MANUALLY.


2. REMOVE THE PERIODIC REFRESH FOR EVERY 30 SECONDS IN THE APP AND ALSO IN THE PPMP PAGE, MAKE THE APPLICATION MORE EFFICIENT AND ONLY FETCH THE DATA FROM THE DATABASE ONCE THEN ALL THE CHANGES IN THE FRONTEND MUST BE DYNAMIC AND REAL-TIME WITHOUT NEEDING TO REFRESH THE APPLICATION OR FETCH AGAIN THE DATA FROM THE DATABASE, MAKE SURE THAT ALL THE CHANGES IN THE FRONTEND ARE SYNCHRONIZED WITH THE DATABASE WITHOUT NEEDING TO REFRESH THE APPLICATION OR FETCH AGAIN THE DATA FROM THE DATABASE. PLEASE FIX THIS ISSUE AS WELL AND MAKE SURE THAT ALL CHANGES IN THE FRONTEND ARE DYNAMIC AND REAL-TIME WITHOUT NEEDING TO REFRESH THE APPLICATION OR FETCH AGAIN THE DATA FROM THE DATABASE. PLEASE COMMUNICATE WITH THE SERVER SIDE TO FIX THIS ISSUE AS WELL.


3. WHEN THE APPLICATION IS BUILD USING THE COMMAND NPM RUN DIST, THE APPLICATION IS NOT ACCESSIBLE TO ALL CLIENTS INSTALLED THE APPLICATION FROM THE DIST, ONLY WHEN THE CLIENT IS USING THE COMMAND NPM START THEN THE APPLICATION IS ACCESSIBLE TO ALL CLIENTS, PLEASE FIX THIS ISSUE AND MAKE THE APPLICATION ACCESSIBLE TO ALL CLIENTS EVEN IF THE APPLICATION IS BUILT USING THE COMMAND NPM RUN DIST. PLEASE COMMUNICATE WITH THE SERVER SIDE IN ORDER TO FIX THIS ISSUE AND ALSO MAKE SURE THAT THE BUILD VERISON OF THE APPLICATION ALSO AUTO DETECTS THE SERVER IP ADDRESS AND MAKE IT ACCESSIBLE TO ALL CLIENTS IN THE NETWORK AND ALSO MAKE SURE IT WILL NOT NEED TO REBUILD THE APPLICATION IN ORDER TO UPDATE THE SERVER IP ADDRESS IN CASE THE SERVER IS RECONNECTED TO ANOTHER NETWORK OR THE SERVER IP ADDRESS CHANGES. MAKE SURE THAT THE AUTO DETECTION OF THE SERVER IP ADDRESS WORKS BOTH IN THE DEVELOPMENT VERSION (NPM START) AND IN THE PRODUCTION BUILD VERSION (NPM RUN DIST) OF THE APPLICATION. ALSO WHEN THERE IS CHANGES IN FRONTEND AND BACKEND IN THE SERVER SIDE THE INSTALLED APPLICATION IN THE CLIENT SIDE MUST ALSO BE UPDATED IN REAL TIME WITHOUT NEEDING TO REINSTALL THE APPLICATION IN THE CLIENT SIDE, MAKE SURE THAT THE APPLICATION CAN AUTO UPDATE ITSELF IN REAL TIME IN CASE THERE ARE CHANGES IN THE FRONTEND AND BACKEND OF THE SERVER SIDE. PLEASE FIX THIS ISSUE AS WELL AND MAKE SURE THAT THE APPLICATION CAN AUTO UPDATE ITSELF IN REAL TIME IN CASE THERE ARE CHANGES IN THE FRONTEND AND BACKEND OF THE SERVER SIDE WITHOUT NEEDING TO REINSTALL THE APPLICATION IN THE CLIENT SIDE. PLEASE COMMUNICATE WITH THE SERVER SIDE TO FIX THIS ISSUE AS WELL.
