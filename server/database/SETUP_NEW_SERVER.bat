...
echo  │  PREREQUISITES                                                        │
echo  ├───────────────────────────────────────────────────────────────────────┤
echo  │  • PostgreSQL 18 installed and running                                │
echo  │  • Port: 5433                                                         │
echo  │  • Password: kurt09908                                                │
echo  │  • pgAdmin 4 Server: dmw_database                                     │
echo  └───────────────────────────────────────────────────────────────────────┘
echo.
echo  ┌───────────────────────────────────────────────────────────────────────┐
...
echo  ├───────────────────────────────────────────────────────────────────────┤
echo  │                                                                       │
echo  │  1. Open PowerShell and navigate to server folder:                    │
echo  │     cd "DMW_System\server"                                            │
echo  │                                                                       │
...
echo  │     node server.js                                                    │
echo  │                                                                       │
echo  │  4. Open NEW PowerShell and navigate to DMW_System folder:            │
echo  │     cd "DMW_System"                                                   │
echo  │                                                                       │
echo  │  5. Install app dependencies:                                         │
echo  │     npm install                                                       │
echo  │                                                                       │
echo  │  6. Start the Electron app:                                           │
echo  │     npm start                                                         │
echo  │                                                                       │
echo  │  7. Login with: admin / admin123                                      │
echo  │                                                                       │
echo  └───────────────────────────────────────────────────────────────────────┘
echo.
