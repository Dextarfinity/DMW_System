...
import type { ReceivedCapitalOutlayItem, ReceivedSemiExpendableItem, PropertyCard } from '@/types';
...
export default function PropertyCardListPage() {
  ...
  const handleViewCard = (id: string, type: 'Capital Outlay' | 'Semi-Expendable') => {
    router.push(`/reports/property-card/${id}?type=${encodeURIComponent(type)}`);
  };
  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-4 sm:p-6 md:p-8">
      <main className="max-w-7xl mx-auto space-y-6">
        <header>
          <h1 className="text-3xl font-bold">Property Cards</h1>
          <p className="text-muted-foreground">Select an item to view its Property Card.</p>
        </header>
