...
import type { ReceivedCapitalOutlayItem, Employee, Designation } from "@/types";
...
export type IssueParFormValues = z.infer<typeof formSchema>;

interface IssueParFormProps {
  item: ReceivedCapitalOutlayItem;
  employees: Employee[];
  designations: Designation[];
  onSubmit: (data: IssueParFormValues) => void;
  onCancel: () => void;
}

export function IssueParForm({ item, employees, designations, onSubmit, onCancel }: IssueParFormProps) {
  const form = useForm<IssueParFormValues>({
